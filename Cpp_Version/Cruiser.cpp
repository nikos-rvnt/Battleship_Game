...
Cruiser::Cruiser(Tile start_index, orientation ornt) : Ship(start_index, ornt) {
	this->size = 3;
}

bool Cruiser::placeShip(Tile start_index, orientation ornt, Board &brd) {
